  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'financial_advisor.count', 'loan.count', 'loan_officer.count'],
          searchTerm: params.searchTerm,
          searchTermKeys: ['description.contains', 'location.contains', 'sector.contains', 'name.contains'],
          ...params.filters,
        },
        'company',
      ),
