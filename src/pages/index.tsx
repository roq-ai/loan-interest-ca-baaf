...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Loan Interest Calculator Application`}</title>

        <meta
          name="description"
          content="Experience simplicity with Loan Interest Calculator Application - Your go-to platform for calculating EMI for Home Loan, Car Loan, Bike Loan, Gold Loan, and more"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1633158829585-23ba8f7c8caf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxsb2FufGVufDB8fHx8MTY5NzU0NTg1Mnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Loan Interest Calculator Application`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience simplicity with Loan Interest Calculator Application - Your go-to platform for calculating EMI for Home Loan, Car Loan, Bike Loan, Gold Loan, and more`}
            </Text>
            <Box
