...
export function LoanListPage(props: LoanListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'company', 'payment_schedule.count'],
          searchTerm: params.searchTerm,
          searchTermKeys: ['loan_type.contains'],
          ...params.filters,
        },
        'loan',
      ),
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('company', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('payment_schedule', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'payment_schedule',
          header: 'Payment Schedule',
          accessorKey: 'payment_schedule',
          cell: ({ row: { original: record } }: any) => record?._count?.payment_schedule,
        }
      : null,
